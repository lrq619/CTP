...
class RunStatus(Enum):
    ...
    PROCESS = 1 # The run is currently collecting data, can sync to cloud server and can also process data
    COLLECT = 2 # The run is currently processing data, cannot sync to cloud server, only can process data
